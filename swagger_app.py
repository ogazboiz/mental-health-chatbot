...
from swagger_config import init_swagger, api, auth_ns, user_ns, sessions_ns, legacy_ns
...
class Register(Resource):
    ...
    @auth_ns.expect(swagger_api.models['Register'])
    @auth_ns.response(200, 'Success', swagger_api.models['AuthResponse'])
...
class Login(Resource):
    ...
    @auth_ns.expect(swagger_api.models['Login'])
    @auth_ns.response(200, 'Success', swagger_api.models['AuthResponse'])
...
class RefreshToken(Resource):
    ...
    @auth_ns.response(200, 'Success')
    @auth_ns.response(401, 'Authentication Error')
    @token_required
    def post(self, user):
...
class UserProfile(Resource):
    ...
    @user_ns.response(200, 'Success', swagger_api.models['ProfileResponse'])
    ...
    @user_ns.doc('update_user_profile', security='Bearer')
    @user_ns.expect(swagger_api.models['ProfileUpdate'])
...
class Sessions(Resource):
    ...
    @sessions_ns.response(200, 'Success', swagger_api.models['SessionsListResponse'])
    ...
    @sessions_ns.expect(swagger_api.models['SessionCreate'])
    @sessions_ns.response(200, 'Success', swagger_api.models['SessionResponse'])
    @sessions_ns.response(401, 'Authentication Error')
    @token_required
    def post(self, user):
...
class Session(Resource):
    @sessions_ns.doc('get_session', security='Bearer')
    ...
    @sessions_ns.doc('update_session', security='Bearer')
    @sessions_ns.expect(swagger_api.models['SessionUpdate'])
    @sessions_ns.response(200, 'Success', swagger_api.models['SessionResponse'])
    @sessions_ns.response(401, 'Authentication Error')
    @sessions_ns.response(404, 'Session not found')
    @token_required
    ...
    @sessions_ns.doc('delete_session', security='Bearer')
    @sessions_ns.response(200, 'Success')
    @sessions_ns.response(401, 'Authentication Error')
    @sessions_ns.response(404, 'Session not found')
    @token_required
...
class SessionMessages(Resource):
    ...
    @sessions_ns.expect(swagger_api.models['MessageSend'])
    @sessions_ns.response(200, 'Success', swagger_api.models['MessageResponse'])
    @sessions_ns.response(401, 'Authentication Error')
    @sessions_ns.response(404, 'Session not found')
    @token_required
...
class SessionMessage(Resource):
    @sessions_ns.doc('edit_message', security='Bearer')
    @sessions_ns.expect(swagger_api.models['MessageEdit'])
    @sessions_ns.response(200, 'Success')
    @sessions_ns.response(401, 'Authentication Error')
    ...
    @sessions_ns.doc('delete_message', security='Bearer')
    @sessions_ns.response(200, 'Success')
    @sessions_ns.response(401, 'Authentication Error')
    @sessions_ns.response(404, 'Session or message not found')
    @token_required
...
# Legacy Endpoints (these remain for backward compatibility)
@legacy_ns.route('/consent')
class Consent(Resource):
    @legacy_ns.doc('set_consent')
    @legacy_ns.expect(swagger_api.models['Consent'])
...
class Feedback(Resource):
    ...
    @legacy_ns.expect(swagger_api.models['Feedback'])
    @legacy_ns.response(200, 'Success')
    @legacy_ns.response(400, 'Bad Request')
    def post(self):
...
class LegacyChat(Resource):
    @legacy_ns.doc('chat')
    @legacy_ns.expect(swagger_api.models['Chat'])
    @legacy_ns.response(200, 'Success')
    @legacy_ns.response(400, 'Bad Request')
